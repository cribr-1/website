  ...
  return (
    <div className="w-full max-w-2xl mx-auto space-y-4 animate-fadeIn">
      ...
      <div className="flex items-center justify-between px-1 py-1">
        <div className="flex items-center text-xl font-black tracking-tight text-neutral-900 dark:text-white">
          <span>crib</span>
          <span className="text-blue-600 dark:text-sky-400">r</span>
        </div>

        <button
          onClick={onBack}
          className="inline-flex items-center space-x-1 text-sm font-medium text-blue-600 dark:text-sky-400 hover:text-blue-700 dark:hover:text-sky-300 transition-colors cursor-pointer"
        >
      ...
      <div className="bg-white dark:bg-neutral-900 border border-neutral-200/90 dark:border-neutral-800 rounded-[20px] p-5 md:p-6 shadow-xs space-y-5">
